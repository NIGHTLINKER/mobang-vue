    ...
    <PostComponent class="mt-5">
      <div slot="posting">
        ...
        <div class="d-flex p-3">
          <b-form-checkbox-group class="w-100" v-model="selectedOptions" :options="options" buttons button-variant="primary" size="lg" name="buttons-2"></b-form-checkbox-group>
        </div>
      </div>
    </PostComponent>
    <PostComponent class="mt-5">
      <div slot="posting">
        ...
        <div class="d-flex" style="height:300px">
          <div class="h-100 flex-container border-left" style="flex:5">
            <div class="w-75">
              <b-form-input class="w-100" v-model="title" placeholder="제목"></b-form-input>
              <b-form-textarea id="textarea-large" size="lg" class="mt-3" rows="7" v-model="content" placeholder="내용"></b-form-textarea>
            </div>
          </div>
        </div>
      </div>
    ...
    <PostComponent>
      <div slot="posting" class="room-deal-information-container">
        ...
        <div class="room-file-upload-wrapper">
          <div v-if="!files.length" class="room-file-example-container">
...
export default {
  ...
  methods:{
    ...
    imageUpload(){
      ...
      // 배열을 생성하는데
      // 실제 파일을 관리하는 부분, 이미지 preview를 관리하는 부분, index까지 관리하는 배열을 제작
      let num=-1;
